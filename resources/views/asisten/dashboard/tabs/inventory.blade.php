                        ...
                        <tr style="border-bottom: 1px solid rgba(255,255,255,0.05); transition: background 0.3s;" onmouseover="this.style.background='rgba(0,217,255,0.05)'" onmouseout="this.style.background='transparent'">
                            ...
                            <td data-label="{{ $lang === 'id' ? 'AKSI' : 'ACTIONS' }}" style="padding: 1rem; text-align: center;">
                                <div style="display: flex; gap: 0.5rem; justify-content: flex-start;">
                                    ...
                                    <form action="{{ route('asisten.inventory.destroy', $inv->id) }}" method="POST" onsubmit="confirmDestructiveAction(event, this, '{{ $lang }}', 'Destructive Warning: Are you sure you want to eradicate this asset?', 'Peringatan Destruktif: Apakah Anda yakin melenyapkan aset ini selamanya?')">
                                        @csrf
                                        @method('DELETE')
    ...
    <div id="addAlatModal" class="custom-modal">
        <div class="modal-content">
            ...
            <form action="{{ route('asisten.inventory.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <!-- Untuk Asisten, Laboratorium ID disembunyikan/diambil dari default controller -->
                    <div class="modal-form-group">
    ...
    <script>
        ...
        function editModal(data) {
            ...
            // Lab diambil dari AsistenController, tidak ada input DOM
            ...
            document.getElementById('editAlatForm').action = '/asisten/dashboard/inventory/' + data.id;
