...
@if($tab === 'overview')
    @include('asisten.dashboard.tabs.overview')
@elseif($tab === 'approvals')
    @include('asisten.dashboard.tabs.approvals')
@elseif($tab === 'returns')
    @include('asisten.dashboard.tabs.returns')
@elseif($tab === 'schedule')
    @include('asisten.dashboard.tabs.schedule')
@elseif($tab === 'inventory')
    @include('asisten.dashboard.tabs.inventory')
@elseif($tab === 'riwayat')
    @include('asisten.dashboard.tabs.riwayat')
@elseif($tab === 'maintenance')
    @include('asisten.dashboard.tabs.maintenance')
@elseif($tab === 'settings')
    @include('master.dashboard.tabs.settings') {{-- settings reuse --}}
@else
...
<script>
    ...
    function confirmDestructiveAction(event, form, lang, textEn, textId) {
        ...
        if (typeof Swal !== 'undefined') {
            Swal.fire({
                title: lang === 'id' ? 'Konfirmasi Verifikasi' : 'Confirm Action',
                text: lang === 'id' ? textId : textEn,
                icon: 'warning',
                showCancelButton: true,
                confirmButtonText: lang === 'id' ? 'LAKUKAN' : 'DO IT',
